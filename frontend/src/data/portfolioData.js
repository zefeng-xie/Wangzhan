...
export const projects = [
  ...
  {
    title: '基于迁移学习的细粒度动物图像分类',
    description:
      '针对10类动物小样本数据集，解决传统CNN训练收敛慢、过拟合严重的问题。加载ResNet-50预训练权重，冻结底层卷积参数，重构顶层全连接层适配10类输出；使用交叉熵损失与Adam优化器，结合学习率衰减与早停法优化训练过程。模型在测试集准确率达92.84%，通过混淆矩阵精准定位易混淆物种，输出完整的评估报告。',
    tags: ['Python', 'PyTorch', 'ResNet-50', '迁移学习', '图像分类', '深度学习'],
  },
  {
    title: '基于感知机的鸢尾花分类',
    description:
      '以鸢尾花数据集为基础，提出感知机分类模型，通过可视化图表分析三种鸢尾花的特征分布，利用多次迭代训练实现对变色鸢尾花的二分类识别，完成分类与识别任务。',
    tags: ['Python', 'scikit-learn', 'Matplotlib', '二分类', '机器学习'],
  },
]

export const contactLinks = [
  { href: 'mailto:1393084112@qq.com', iconClass: 'fa-solid fa-envelope', label: '邮箱', tooltip: '1393084112@qq.com' },
  { href: 'https://github.com/zefeng-xie', iconClass: 'fa-brands fa-github', label: 'GitHub', newTab: true },
]
